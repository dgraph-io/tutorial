...
So in order to Expand or Delete nodes. You need to define your Types correctly. You can see in detail more about the [Type System here](https://dgraph.io/docs/master/query-language/#type-system).
