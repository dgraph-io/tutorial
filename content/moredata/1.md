...
and actors](https://github.com/dgraph-io/tutorial/resources/data/1million.rdf.gz).  
...
```
wget "https://github.com/dgraph-io/tutorial/resources/data/1million.rdf.gz?raw=true" -O 1million.rdf.gz -q
```
