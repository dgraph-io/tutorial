...
and actors](https://github.com/dgraph-io/benchmarks/tree/master/data/1million.rdf.gz).  
...
```sh
cd ~/dgraph
wget "https://github.com/dgraph-io/benchmarks/blob/master/data/1million.rdf.gz?raw=true" -O 1million.rdf.gz -q
```
