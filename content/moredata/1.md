...
```sh
docker cp 1million.rdf.gz dgraph_zero_1:/dgraph # Copy the file from your host to the container
docker exec -it dgraph_zero_1 dgraph live -r 1million.rdf.gz --zero localhost:5080 -c 1
```
