...
Checking the last page you can se that directors are part of Person Type and have a `name` and are connected to the movies they directed via `director.film`.
